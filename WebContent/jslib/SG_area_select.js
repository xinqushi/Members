...
$(document).ready(function() {
	$.areaSelect = function(init) {
		...
		function createDom() {
			var html = '';
			html += '<div id="provinces" class="container">';
			html += '<div class=""><h3>请选择地区</h3>';
			html += '<div class="content-box">';
			html += '<div id="wrapper0" class="tab-content tab-list-1 isBlock">';
			html += '<ul class="list-inline"></ul>';
			html += '</div>';
			html += '</div>';
			html += '</div>';
			html += '</div>';
...
/*			$('.tab-1').click(function() {
			...
			for(var i = 0; i < CityJson.length; i++) {
				provinceDom += '<li><a class="btn btn-default">' + CityJson[i].region.name + '<input value=' + CityJson[i].region.code + ' style="display:none"></a></li>';
			}
