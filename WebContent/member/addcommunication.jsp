...
沟通时间：<input type="text" id="time"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true,minDate:'%y-{%M-1}-%d',maxDate:'%y-%M-%d'})"class="input-text Wdate" style="width:120px;">&nbsp;&nbsp;*默认为今天<br>
<br>
