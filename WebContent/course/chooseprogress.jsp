...
<div style="margin-left:20px;font-size:16px;color:green">双击&nbsp;&nbsp;&nbsp;<img src='${pageContext.request.contextPath}/images/ok-green.png'>&nbsp;&nbsp;&nbsp;<img src='${pageContext.request.contextPath}/images/x-red.png'>&nbsp;&nbsp;&nbsp;图标选择当前学习进度，选修课可跳过选择；只有可选的专业才能设置进度</div>
	<div>
