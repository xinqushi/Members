	...
	*/
	...
	function drawTable(data){
		...
		for(i=0;i<data.length;i++){
			...
			line=line+status;
			line=line +"</td>";	
			line += "<td class='noclick'><a href='javascript:void(0)' class='gtxx' lang='" + data[i].id +"&"+data[i].identityType+"'>沟通</a></td>";
   ...
   <input type="hidden" id="look" value="0">
	...
	<form id="">
		...
		<span class="select-box inline">
			<select name="assistant" class="select">			
			</select>
		</span>&nbsp; &nbsp;
		审核状态：
		<span class="select-box inline">
			<select id="checkType" name="checkType" class="select" onchange="checkTypeChange(this.value);">
